export default async function preloadHandlebarsTemplates() {
  const templatePaths = [
    ...
    "systems/mw-destiny/templates/parts/hardware/settings-pane.hbs",
    ...
    "systems/mw-destiny/templates/parts/shared/attributes-pane.hbs",
    "systems/mw-destiny/templates/parts/shared/skills-pane.hbs",
